Locales['br'] = {
  ...
  ['veh_stored']                = 'Pressione ~INPUT_CONTEXT~ para armazenar o veículo.',
  ...
  ['not_enough_body_tools']     = 'Você não tem ~r~ferramentas carroçaria~s~ o suficiente.',
  ['assembling_body_kit']       = 'Fabricando ~b~Kit de carroçaria~s~...',
  ...
  ['player_cannot_hold']        = 'você não tem espaço livre suficiente no seu inventário!',
}
